...
load_path = 'E:/ProjectData/BasicSeq2Seq/'
save_path = 'E:/ProjectData/BasicSeq2Seq-Evaluate/'
os.environ["CUDA_VISIBLE_DEVICES"] = "1"
if not os.path.exists(save_path): os.makedirs(save_path)

if __name__ == '__main__':
    train_data, val_data, test_data = loader_cnndm(batch_size=4)
    tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
    for evaluate_index in range(60, 0, -1):
        ...
        total_generated = []
        for batch_index, [batch_article, batch_summary] in enumerate(tqdm.tqdm(val_data)):
        ...
        json.dump(total_generated, open(os.path.join(save_path, '%03d-Val.json' % evaluate_index), 'w'))
        # exit()
